...
## Step:  Setup sonarqube webhook
- go to sonarqube
- click on administration-->configuration
- select webhook
- create webhook -->provide name and jenkins url/sonarqube-webhoook and create
<img width="538" height="666" alt="image" src="https://github.com/user-attachments/assets/adfe8b44-c89a-4ebb-b5e1-df0fbccc1995" />
